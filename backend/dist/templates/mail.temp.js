...
exports.bookingConfirmationEmail = exports.bookingStatusEmail = exports.passwordResetEmail = exports.welcomeEmail = void 0;
...
`;
exports.bookingStatusEmail = bookingStatusEmail;
const bookingConfirmationEmail = (listingName, checkIn, checkOut) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
